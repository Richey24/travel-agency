                         ...
                         <div id="why1">
                              <div className="container">
                                   ...
                                   <div className="title1 animated">
                                        ...
                                        dedicated to serving the needs of religious travelers. We're
                                        not your average travel provider - we're partnering with
                                        major religious organizations to offer their members a
                                        specialized and personalized booking experience. <br />
                                                       ...
                                                       <a href="#">
                                                            ...
                                                            <div className="caption">
                                                                 ...
                                                                 <div className="txt2">
                                                                      ...
                                                                      providing members with access
                                                                      to specialized accommodation
                                                                      and amenities
                                                                 </div>
                                                                 <div className="txt3">
                                                                      Read More
                                                  ...
                                                  <div className="thumbnail clearfix">
                                                       <a href="#">
                                                            ...
                                                            <div className="caption">
                                                                 ...
                                                                 <div className="txt2">
                                                                      Affordable rate and exclusive
                                                                      deals for members of religious
                                                                      organizations, ensuring that
                                                                      our guests can travel with
                                                                      ease and comfort.
                                                                 </div>
                                                                 <div className="txt3">
                                                                      Read More
                                             ...
                                             <div className="content">
                                                  ...
                                                  >
                                                       ...
                                                       <p>
                                                            Lorem ipsum dolor sit amet, consectetuer
                                                            adipiscing elit, sed diam nonummy nibh
                                                            euisod tincidunt ut laoreet dolore magna
                              ...
                              <div className="container">
                                   <div className="row">
                                        <div className="col-sm-3">
                                             ...
                                             <p>
                                                  Welcome to our revolutionary new booking site that
                                                  is dedicated to serving the needs of religious
                                                  travelers. We're not your average travel provider
                                                  - we're partnering with major religious
                                                  organizations to offer their members a specialized
                                                  and personalized booking experience. <br />
                                                  Our team understand and value your faith
                                             </p>
                                             <p>
                                        ...
                                        <div className="col-sm-3">
                                             ...
                                             <div className="twits1">
                                                  <div className="twit1">
                                                       <a href="#"> @travel</a> Lorem ipsum dolor
                                                       sit amet, consectetuer adipiscing elit
                                                       <div className="date">5 minutes ago</div>
                                                  </div>
                                                  <div className="twit1">
                                                       <a href="#">@leo</a> Nam liber tempor cum
                                                       soluta nobis option congue nihil imperdiet
